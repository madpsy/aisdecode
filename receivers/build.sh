...
build_binary linux   amd64   "receivers-linux-amd64"
build_binary darwin  amd64   "receivers-darwin-amd64"
build_binary windows amd64   "receivers-windows-amd64.exe"
build_binary linux   arm     "receivers-linux-arm"
build_binary linux   arm64   "receivers-linux-arm64"
