...
build_binary linux   amd64   "statistics-linux-amd64"
build_binary darwin  amd64   "statistics-darwin-amd64"
build_binary windows amd64   "statistics-windows-amd64.exe"
build_binary linux   arm     "statistics-linux-arm"
build_binary linux   arm64   "statistics-linux-arm64"
