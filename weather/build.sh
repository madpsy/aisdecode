...
build_binary linux   amd64   "weather-linux-amd64"
build_binary darwin  amd64   "weather-darwin-amd64"
build_binary windows amd64   "weather-windows-amd64.exe"
build_binary linux   arm     "weather-linux-arm"
build_binary linux   arm64   "weather-linux-arm64"
